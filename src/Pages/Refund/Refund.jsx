...
import RefundPolicy from '../../images/RefundPolicy.jpg'
    ...
    return (
        <div>
            ...
            <div className='container'>
                <Typography variant='h4' className='pt-3'><b>Cancellation and Refund Policy</b></Typography>
                <Typography variant='subtitle1'>
                    Cancellation and Refund Policy
                    To request a refund, please contact us through  HOTELIO Help Center.
                    Cancelling a HOTELIO is as fast and easy as booking one.</Typography>
                <Grid container spacing={1}>
                    <Grid xs={4} sx={{ display: 'grid', placeItems: 'center' }}>
                        <img src={RefundPolicy} alt="refundPolicy" />
                    </Grid>
                    <Grid xs={8}>
                        <p className='py-2'>
                            <ol>
