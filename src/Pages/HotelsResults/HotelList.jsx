...
import { Card, Container, Grid, Button, Pagination, Select, MenuItem } from '@mui/material';
        ...
        <Container >
            ...
            <Grid sx={{ margin: '10px 0px' }} container >
                ...
                <Grid item xs={12} lg={12} xl={12}>
                    <div className="d-flex justify-content-between align-items-center">
                        <h4>Here is your Searched Reasults of Jammu and Kashmir</h4>
                        <Select
            ...
            <Card fluid sx={{ p: 1 }}>
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} lg={4} xl={4} className={`${style.SecondGridView}`}>
                        <div>
                            <div className={`align-items-center p-2 ${style.BookingCardColor} ${style.mobflex}`}>
                                <h4>₹1345 <span><del>1645</del></span></h4> <span className='text-danger'>64% off</span>
                            </div>
