        ...
        <div className="w-100">
            ...
            >
                <div className={`${style.Container}`}>
                    <div className={`row ${style.rowRevert}`}>
                        <div className="col-12 p-0">
                            <nav
                                ...
                                <ul className={`${style.nav}`}>
                                    ...
                                    <li>
                                        <NavLink to="/signin" className={`${!list ? "text-dark" : ""}`}>
                                            ...
                                            <li>
                                                ...
                                                >
                                                    <MenuItem onClick={handleClose} disableRipple>
                                                        ...
                                                        <Link to={'/CustomerNameProfile'}>My Profile</Link>
                                                    </MenuItem>
                                                    <Divider sx={{ my: 0.2 }} />
                                                    <MenuItem onClick={handleClose} disableRipple>
                    ...
                    <span className={style.main_white_button}></span>
                                ...
                                <div className={` ${style.search_form}`}>
                                    <div className={`row position-relative m-0 ${style.rowRevert}`}>
                                                        ...
                                                        <div className="row">
                                                            <div className="ms-1 me-5 ms-2 col-md-4 ">
                                                                ...
                                                                <div className={style.optionItem}>
                                                                    ...
                                                                    <div
                                                                        className={`ms-4 ${style.optionCounter}`}
                                                                    >
                                                                        <button
                                        ...
                                        <div
                                            className={` p-0 ${isDesktop ? "mt-3" : ""} ${nav2 || navSearch ? "col-lg-2" : "col-lg-3"
                                                }`}
                                        >
                                            <fieldset>
                                                <button
