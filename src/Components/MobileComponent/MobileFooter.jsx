            ...
            <Offcanvas placement='end' show={show} onHide={handleClose}>
                ...
                <Offcanvas.Body className='pt-0 mt-0'>
                    ...
                    <ul>
                        ...
                        {/* <li style={{ color: '#ee2e24', borderBottom: '1px solid #ee2e24' }} className='py-2'><Typography variant='h6' onClick={() => navigate('/profile')} ><PersonIcon sx={{ mr: 2 }} /> Profile</Typography></li> */}
                        ...
                        <li style={{ color: '#ee2e24' }} className='py-2'><Typography variant='h6' onClick={() => navigate('/signin')} ><LoginRoundedIcon sx={{ mr: 2 }} /> Login / Signup</Typography></li>
                    </ul>
                </Offcanvas.Body>
            </Offcanvas>
        )
